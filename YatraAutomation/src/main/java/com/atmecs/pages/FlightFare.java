...
public class FlightFare {
	 ...
	 * @param driver
	 */
	public void isBaseFareCorrect(WebDriver driver) {
		WebElement key = CommonUtility.getElement(driver, YatraFlightBookingLocators.getLocators("loc.btn.basefare"));
	 ...
	 * @param driver
	 */
	public void isFeeAndSurchargesCorrect(WebDriver driver) {
		WebElement key = CommonUtility.getElement(driver,
	 ...
	 * @param driver
	 */
	public void isTotalFareCorrect(WebDriver driver) {
		WebElement key = CommonUtility.getElement(driver, YatraFlightBookingLocators.getLocators("loc.btn.totalFare"));
		String element = key.getText();
